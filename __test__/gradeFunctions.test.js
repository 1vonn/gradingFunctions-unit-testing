...
test('gradeMathPhysicsChemistry function', () => {
    ...
    expect(gradeMathPhysicsChemistry(45)).toBe("D");
    expect(gradeMathPhysicsChemistry(35)).toBe("E");
});
...
test('gradeReligiousEducation function', () => {
    ...
    expect(gradeReligiousEducation(55)).toBe("D");
    expect(gradeReligiousEducation(45)).toBe("E");
});
...
test('gradeEnglishSwahiliComputer function', () => {
    ...
    expect(gradeEnglishSwahiliComputer(45)).toBe("D");
    expect(gradeEnglishSwahiliComputer(35)).toBe("E");
});
